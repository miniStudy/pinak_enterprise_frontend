...
function Machine_types_insert({fetchdata}) {
  ...
  return (
    <>
    <button type="button" className="btn btn-sm ms-2 btn-primary" onClick={openModal}>Add Machine Type
    </button>
    <div
...
export default Machine_types_insert